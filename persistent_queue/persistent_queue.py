...
"""
_DELETE_PROCESSED_LOGS = """
DELETE FROM log WHERE id <= (SELECT MIN(acknowledged) FROM clients)
"""
...
class Queue:
  ...
  def garbage_collect(self):
    """Deletes messages that have been acknowledged by all clients."""
    self._execute(_DELETE_PROCESSED_LOGS)
